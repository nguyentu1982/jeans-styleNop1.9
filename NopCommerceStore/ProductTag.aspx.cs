...
namespace NopSolutions.NopCommerce.Web
{
    public partial class ProductTagPage : BaseNopFrontendPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (productTag != null)
            {
                string title = productTag.MetaTile;                
                SEOHelper.RenderTitle(this.Page, title, true);
                string description = productTag.MetaDescription;
                string keyword = productTag.MetaKeywords;
                SEOHelper.RenderMetaTag(this.Page, "description", description, true);
                SEOHelper.RenderMetaTag(this.Page, "keywords", keyword, true);
