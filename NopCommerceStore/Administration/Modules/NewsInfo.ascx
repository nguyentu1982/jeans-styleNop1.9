...
<table class="adminContent">
    ...
    <tr>
        <td class="adminTitle">
            <nopcommerce:tooltiplabel runat="server" id="lblImage" text="<% $NopResources:Admin.NewsInfo.Image %>"
                tooltip="<% $NopResources:Admin.NewsInfo.Image.Tooltip %>" tooltipimage="~/Administration/Common/ico-help.gif" />
        </td>
        <td class="adminData">
            <asp:Image ID="iNewsPicture" runat="server" />
            <br />
            <asp:Button ID="btnRemoveNewsImage" CssClass="adminButton" CausesValidation="false"
                runat="server" Text="<% $NopResources:Admin.NewsInfo.RemoveImage %>"
                OnClick="btnRemoveNewsImage_Click" Visible="false" />
            <br />
            <asp:FileUpload ID="fuNewsPicture" CssClass="adminInput" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="adminTitle">
