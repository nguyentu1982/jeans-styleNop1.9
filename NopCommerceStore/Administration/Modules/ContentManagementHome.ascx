...
<div class="homepage">
    ...
    <div class="options">
        <ul>
            ...
            <li>
                <div class="title">
                    <a href="servicehome.aspx" title="<%=GetLocaleResourceString("Admin.ContentManagementHome.ServiceHome.TitleDescription")%>">
                        <%=GetLocaleResourceString("Admin.ContentManagementHome.ServiceHome.Title")%></a>
                </div>
                <div class="description">
                    <p>
                        <%=GetLocaleResourceString("Admin.ContentManagementHome.ServiceHome.Description")%>
                    </p>
                </div>
            </li>
            <li>
