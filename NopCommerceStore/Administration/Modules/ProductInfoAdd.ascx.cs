...
namespace NopSolutions.NopCommerce.Web.Administration.Modules
{
    public partial class ProductInfoAddControl : BaseNopAdministrationUserControl
    {
        private void BindData()
        {
            ...
            //Disable buy button if ShoppingCard is not enable
            if (!this.SettingManager.GetSettingValueBoolean("Common.EnableShoppingCard"))
            {
                cbDisableBuyButton.Checked = true;
                cbDisableBuyButton.Enabled = false;
            }
        }
        ...
        private void FillDropDowns()
        {
            ...
            //Default Warehouse
            CommonHelper.SelectListItem(this.ddlWarehouse, this.SettingManager.GetSettingValueInteger("Common.DefaultWarehouseId", 1));
