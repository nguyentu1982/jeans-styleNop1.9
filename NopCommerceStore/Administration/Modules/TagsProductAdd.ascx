<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Administration.Modules.TagsProductAddControl"
    CodeBehind="TagsProductAdd.ascx.cs" %>
...
<br />
<asp:Button ID="btnSave" runat="server" CssClass="adminButton" Text="<% $NopResources:Admin.AddTagProduct.SaveColumn %>"
    ToolTip="<% $NopResources:Admin.AddTagProduct.SaveColumn.Tooltip %>" OnClick="btnSave_Click"
    Visible="false" />
