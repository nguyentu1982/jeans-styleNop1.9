...
{
    public partial class ServiceControl : BaseNopAdministrationUserControl
    {
        ...
        void BindData()
        {
            var newsCollection = this.ServiceService.GetAllService(0);
            gvService.DataSource = newsCollection;
            gvService.DataBind();
        }
