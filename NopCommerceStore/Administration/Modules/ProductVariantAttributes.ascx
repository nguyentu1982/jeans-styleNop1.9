...
<%@ Register TagPrefix="nopCommerce" TagName="SelectProductAttributes" Src="~/Modules/ProductAttributes2.ascx" %>
                ...
                <ContentTemplate>
                    ...
                    <table class="adminContent">
                        ...
                        <tr>
                            ...
                            <td class="adminData">
                                <asp:TextBox runat="server" CssClass="adminInput" ID="txtNewTextPrompt" Text="<% $NopResources:Admin.ProductVariantAttributes.New.Text %>"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="adminTitle">
