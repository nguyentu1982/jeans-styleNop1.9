...
<asp:Panel runat="server" ID="pnlData" CssClass="pnlPicture">
    <asp:GridView ID="gvwImages" runat="server" AutoGenerateColumns="false" DataKeyNames="ProductPictureId"
        ...
        <Columns>
            <asp:TemplateField HeaderText="<% $NopResources:Admin.ProductPictures.Image %>" ItemStyle-Width="50%">
                <ItemTemplate>
                    <asp:Image ID="iProductPicture" runat="server" AlternateText="pic" Width="100px" />
            ...
            <asp:TemplateField HeaderText="<% $NopResources:Admin.ProductPictures.PictureDescription %>"
                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:TextBox runat="server" ID="txtPictureDescription1" CssClass="adminInput" Text='<%# Eval("PictureDescription") %>' Height="100" TextMode="MultiLine"></asp:TextBox>                    
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <table class="adminContent">
        <tr>
            ...
            <td class="adminTitle">
                <nopCommerce:ToolTipLabel runat="server" ID="lbPictureDescription1" Text="<% $NopResources:Admin.ProductPictures.PictureDescription %>"
                    ToolTip="<% $NopResources:Admin.ProductPictures.PictureDescription.Tooltip %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
            </td>
            <td class="adminData">
                <asp:Textbox runat="server" ID="txtPictureDescription1" CssClass="adminInput">
                </asp:Textbox>
            </td>
        </tr>
        <tr>
        ...
        <tr id="upl21" style="display: none;">
            ...
            <td class="adminTitle">
                <nopCommerce:ToolTipLabel runat="server" ID="lbPictureDescription2" Text="<% $NopResources:Admin.ProductPictures.PictureDescription %>"
                    ToolTip="<% $NopResources:Admin.ProductPictures.PictureDescription.Tooltip %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
            </td>
            <td class="adminData">
                <asp:Textbox runat="server" ID="txtPictureDescription2" CssClass="adminInput">
                </asp:Textbox>
            </td>
        </tr>
        ...
        <tr id="upl31" style="display: none;">
            ...
            <td class="adminTitle">
                <nopCommerce:ToolTipLabel runat="server" ID="lbPictureDescription3" Text="<% $NopResources:Admin.ProductPictures.PictureDescription %>"
                    ToolTip="<% $NopResources:Admin.ProductPictures.PictureDescription.Tooltip %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
            </td>
            <td class="adminData">
                <asp:Textbox runat="server" ID="txtPictureDescription3" CssClass="adminInput">
                </asp:Textbox>
            </td>
        </tr>
