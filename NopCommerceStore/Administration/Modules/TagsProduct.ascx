<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Administration.Modules.TagsProductControl"
    CodeBehind="TagsProduct.ascx.cs" %>
        ...
        <td width="100%">
            ...
            <asp:UpdatePanel ID="upMappings" runat="server">
                <Triggers >
                    ...
                    <asp:PostBackTrigger ControlID="gvProductCategoryMappings" />
                </Triggers>
                <ContentTemplate>
                    <asp:GridView ID="gvProductCategoryMappings" runat="server" AutoGenerateColumns="false"
                        Width="100%" AllowPaging="true" PageSize="10" OnPageIndexChanging="gvProductCategoryMappings_PageIndexChanging">
                        <Columns>
