...
<table class="adminContent">
    ...
    <tr>
        ...
        <td class="adminData">
            <asp:CheckBox ID="cbAllowCustomerRatings" runat="server" Checked="False"></asp:CheckBox>
        </td>
    </tr>
    <tr>
        <td class="adminTitle">
    ...
    <tr id="pnlFreeShipping">
        ...
        <td class="adminData">
            <asp:CheckBox ID="cbIsFreeShipping" runat="server" Checked="True"></asp:CheckBox>
        </td>
    </tr>
        ...
        <td class="adminData">
            <asp:DropDownList ID="ddlManageStock" runat="server">
                ...
                <asp:ListItem Text="<% $NopResources:Admin.ManageInventoryMethod.ManageByAttributes %>"
                    Value="2" Selected="True"></asp:ListItem>
            </asp:DropDownList>
        </td>
    </tr>
