...
{
    public partial class ProductBoxRecentlyAddedProductOnHomepageControl: BaseNopFrontendUserControl
    {
        ...
        public int ProductImageSize
        {
            get
            {
                if (ViewState["ProductImageSize"] == null)
                    return this.SettingManager.GetSettingValueInteger("Media.Product.ThumbnailImageSizeRecentlyAddedProduct", 140);
                else
