<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.ProductBoxRelatedProductControl"
    CodeBehind="ProductBoxRelatedProduct.ascx.cs" %>
