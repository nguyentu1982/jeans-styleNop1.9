<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.ProductBoxRecentlyAddedProductOnHomepageControl"
    CodeBehind="ProductBoxRecentlyAddedProductOnHomepage.ascx.cs" %>
