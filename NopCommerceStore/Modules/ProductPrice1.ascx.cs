                        ...
                        !NopContext.Current.User.IsGuest))
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            int intFinalPriceWithoutDiscount = (Int32)finalPriceWithoutDiscount;
                            string urlNganLuongFinalPriceWithoutDiscount = "https://www.nganluong.vn/button_payment.php?receiver=quanjeandep@gmail.com&product_name='" + productVariant.Product.Name + "'&price='" + intFinalPriceWithoutDiscount.ToString() + "'&return_url='http://quanjeandep.com'&comments=''";
                            string urlBaoKimFinalPriceWithoutDiscount = "https://www.baokim.vn/payment/customize_payment/product?business=quanjeandep@gmail.com&product_name='"+productVariant.Product.Name + "'&product_price="+intFinalPriceWithoutDiscount.ToString() + "&product_quantity=1&total_amount="+ intFinalPriceWithoutDiscount.ToString() + "&product_description=''"; 
                            ...
                            int intFinalPriceWithDiscount = (Int32)finalPriceWithDiscount;
                            string urlNganLuongFinalPriceWithtDiscount = "https://www.nganluong.vn/button_payment.php?receiver=quanjeandep@gmail.com&product_name='" + productVariant.Product.Name + "'&price='" + intFinalPriceWithDiscount.ToString() + "'&return_url='http://quanjeandep.com'&comments=''";
                            string urlBaoKimFinalPriceWithDiscount = "https://www.baokim.vn/payment/customize_payment/product?business=quanjeandep@gmail.com&product_name='" + productVariant.Product.Name + "'&product_price=" + intFinalPriceWithDiscount.ToString() + "&product_quantity=1&total_amount=" + intFinalPriceWithDiscount.ToString() + "&product_description=''"; 
                            ...
                            if (finalPriceWithoutDiscountBase != finalPriceWithDiscountBase)
                            {
                                ...
                                (Parent.FindControl("lkNganLuong") as HyperLink).NavigateUrl = urlNganLuongFinalPriceWithtDiscount;
                                (Parent.FindControl("lkBaoKim") as HyperLink).NavigateUrl = urlBaoKimFinalPriceWithDiscount;
                            }
                            else
                            {
                                phDiscount.Visible = false;
                            ...
                            {
                                lblPriceValue.CssClass = "oldProductPrice";
                            }
                            else
                            {
                            ...
                            {
                               Parent.FindControl("imgFreeShiping").Visible = true;
                               (Parent.FindControl("imgFreeShiping") as Image).ImageUrl = string.Format("{0}{1}", CommonHelper.GetStoreLocation(), GetLocaleResourceString("FreeShippingUrl"));
                               (Parent.FindControl("imgFreeShiping") as Image).AlternateText = GetLocaleResourceString("FreeShipping.Description");
                               (Parent.FindControl("imgFreeShiping") as Image).Attributes.Add("title", GetLocaleResourceString("FreeShipping.Description"));
                            }
                        }
                    }
                }
