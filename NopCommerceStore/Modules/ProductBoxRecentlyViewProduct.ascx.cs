...
{
    public partial class ProductBoxRecentlyViewProductControl: BaseNopFrontendUserControl
    {
        ...
        public int ProductImageSize
        {
            get
            {
                if (ViewState["ProductImageSize"] == null)
                    return this.SettingManager.GetSettingValueInteger("Media.Product.ThumbnailImageSizeRelatedProduct", 100);
                else
