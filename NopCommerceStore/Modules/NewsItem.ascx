...
<%@ Register TagPrefix="nopCommerce" TagName="NewsListOnBottomNewsPage" Src="~/Modules/NewsListOnBottomNewsPage.ascx" %>
<div class="newsitem">
...
<nopCommerce:NewsListOnBottomNewsPage ID="ctrlNewsList" runat="server"/>
