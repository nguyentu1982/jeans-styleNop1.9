<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.AddressDisplayConfirmPage"
    CodeBehind="AddressDisplayConfirmPage.ascx.cs" %>
<table width="100%" cellspacing="0" cellpadding="2" border="0">
    <tbody>
        <tr>
            <td style="vertical-align: middle; padding-left: 15px;">
                <b><%=GetLocaleResourceString("Address.FullName")%>:
                            ...
                            <td>
                                ...
                                <div>
                                   <%-- <%=GetLocaleResourceString("Address.Fax")%>:--%>
                                    <asp:Literal ID="lFaxNumber" runat="server" Visible="false"></asp:Literal></div>
                                <asp:Panel ID="pnlCompany" runat="server">
                                    <asp:Literal ID="lCompany" runat="server"></asp:Literal></asp:Panel>
                                <div>
                                    <%=GetLocaleResourceString("Address.Address")%>:
