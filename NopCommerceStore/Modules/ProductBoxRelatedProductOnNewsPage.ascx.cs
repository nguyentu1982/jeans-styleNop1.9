...
{
    public partial class ProductBoxRelatedProductOnNewsPageControl : BaseNopFrontendUserControl
    {
        ...
        public int ProductImageSize
        {
            get
            {
                if (ViewState["ProductImageSize"] == null)
                    return this.SettingManager.GetSettingValueInteger("Media.Product.ThumbnailImageSizeRelatedProductOnNewsPage", 200);
                else
