<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.ProductBoxRelatedProductOnNewsPageControl"
    CodeBehind="ProductBoxRelatedProductOnNewsPage.ascx.cs" %>
...
<div class="relatedproduct-item-on-news">
    <div class="picture">
