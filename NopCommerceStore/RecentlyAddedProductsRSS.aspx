...
<asp:repeater id="rptrRecentlyAddedProducts" runat="server">
    ...
    <ItemTemplate>
        <item>         
         ...
         <description><![CDATA[<img align="left" hspace="5" src="<%#this.PictureService.GetPictureUrl((Picture)Eval("DefaultPicture"), 300)%>"/> <%# Eval("LocalizedShortDescription") %>]]></description>
