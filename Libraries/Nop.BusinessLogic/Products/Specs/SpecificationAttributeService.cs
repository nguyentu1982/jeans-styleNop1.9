...
namespace NopSolutions.NopCommerce.BusinessLogic.Products.Specs
{
    ...
    public partial class SpecificationAttributeService : ISpecificationAttributeService
    {
        ...
        public SpecificationAttributeOption GetSpecificationAttributeOption(string attributeName, string value)
        {
            int specificationAttributeOptionId = 0;
            int specificationAttributeId = 0;
            var q = from sa in _context.SpecificationAttributes
                    where sa.Name.ToLower() == attributeName.ToLower()
                    select sa;
            specificationAttributeId = q.ToList()[0].SpecificationAttributeId;

            var q1 = from sa in _context.SpecificationAttributeOptions
                     where sa.Name == value && sa.SpecificationAttributeId == specificationAttributeId
                     select sa;
            specificationAttributeOptionId = q1.ToList()[0].SpecificationAttributeOptionId;
            return GetSpecificationAttributeOptionById(specificationAttributeOptionId);
        }
        /// <summary>
        ...
        #region Specification attribute option filter for manufacturer
        ...
        /// <param name="categoryId">Category identifier</param>
        /// <returns>Product specification attribute mapping collection</returns>
        public List<SpecificationAttributeOptionFilter> GetSpecificationAttributeOptionFilterManufacturer(int manufacturerId)
        {
            int languageId = NopContext.Current.WorkingLanguage.LanguageId;
            return GetSpecificationAttributeOptionFilterManufacturer(manufacturerId, languageId);
        }
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Product specification attribute mapping collection</returns>
        public List<SpecificationAttributeOptionFilter> GetSpecificationAttributeOptionFilterManufacturer(int manufacturerId, int languageId)
        {

            var result = _context.Sp_SpecificationAttributeOptionFilterManufacturer_LoadByFilter(manufacturerId, languageId).ToList();
            return result;
        }
