...
namespace NopSolutions.NopCommerce.BusinessLogic.Products.Specs
{
    ...
    public partial interface ISpecificationAttributeService
    {
        ...
        /// <param name="categoryId">Category identifier</param>
        /// <returns>Product specification attribute mapping collection</returns>
        List<SpecificationAttributeOptionFilter> GetSpecificationAttributeOptionFilterManufacturer(int manufacturerId);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Product specification attribute mapping collection</returns>
        List<SpecificationAttributeOptionFilter> GetSpecificationAttributeOptionFilterManufacturer(int manufacturerId, int languageId);

        #endregion

        SpecificationAttributeOption GetSpecificationAttributeOption(string attributeName, string attributeValue);
    }
}
