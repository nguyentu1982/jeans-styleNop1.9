...
namespace NopSolutions.NopCommerce.BusinessLogic.Products
{
    ...
    public partial interface IProductService
    {
        ...
        /// </summary>
        /// <returns>Product collection</returns>
        List<Product> GetAllProductsDisplayedOnHomePageSortByCreatedDate();
        ...
        /// <summary>
        /// Gets a list of other products
        /// </summary>
        /// <param name="productId">Product identifier</param>
        /// <returns>Product collection</returns>
        List<Product> GetProductsOthersById(int productId);
        ...
        void UpdateSizeToFilterInCategoryPage();
        ...
        /// <summary>
        /// Gets or sets a number of "Recently added products" on Homepae
        /// </summary>
        int RecentlyAddedProductsNumberOnHomepage { get; set; }
        /// <summary>
