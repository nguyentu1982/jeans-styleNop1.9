...
namespace NopSolutions.NopCommerce.BusinessLogic.Data
{
    ...
    public partial class NopObjectContext : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<ServiceComment> ServiceComments
        {
            get
            {
                if ((_ServiceComments == null))
                {
                    _ServiceComments = base.CreateObjectSet<ServiceComment>("ServiceComments");
                }
                return _ServiceComments;
            }
        }
        private ObjectSet<ServiceComment> _ServiceComments;
