...
namespace NopSolutions.NopCommerce.BusinessLogic.Data
{
    ...
    public partial class NopObjectContext : ObjectContext
    {
        ...
        /// <param name="manufacturerID">No Metadata Documentation available.</param>
        /// <param name="languageID">No Metadata Documentation available.</param>
        public ObjectResult<SpecificationAttributeOptionFilter> Sp_SpecificationAttributeOptionFilterManufacturer_LoadByFilter(Nullable<global::System.Int32> manufacturerID, Nullable<global::System.Int32> languageID)
        {
            ObjectParameter manufacturerIDParameter;
            if (manufacturerID.HasValue)
            {
            ...
            return base.ExecuteFunction<SpecificationAttributeOptionFilter>("Sp_SpecificationAttributeOptionFilterManufacturer_LoadByFilter", manufacturerIDParameter, languageIDParameter);
        }
    
        /// <summary>
        /// No Metadata Documentation available.
        /// </summary>
        public int ProductSpecificationFilterSize()
        {
            return base.ExecuteFunction("ProductSpecificationFilterSize");
        }
