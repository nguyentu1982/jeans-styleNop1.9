...
namespace NopSolutions.NopCommerce.BusinessLogic.SEO
{
    ...
    public partial class SEOHelper
    {
        ...
        public static void AddCanonicalTag(Page page, string[] queryStringPara)
        {
            ...
            {
                foreach (string s in queryStringPara)
                {
                    querystringstocheck.Add(s);
                }
            }
        ...
        {
            string url = string.Format("{0}servicelist.aspx", CommonHelper.GetStoreLocation());
            return url.ToLowerInvariant();
        }

        public static string GetServiceUrl(int serviceId)
        {
            var service = IoC.Resolve<IServiceService>().GetServiceById(serviceId);
        ...
        public static string GetServiceUrl(Service service)
        {
            ...
            string seName = GetSEName(service.Title);
            string url2 = SEOHelper.EnableUrlRewriting ? IoC.Resolve<ISettingManager>().GetSettingValue("SEO.Service.UrlRewriteFormat") : "{0}Service.aspx?ServiceId={1}";
            string url = string.Format(url2, CommonHelper.GetStoreLocation(), service.ServiceId, seName);
            return url.ToLowerInvariant();
        }
        #endregion Service
        ...
        /// <summary>
        /// Gets Service Rss URL
        /// </summary>
        /// <returns>News Rss URL</returns>
        public static string GetServiceRssUrl()
        {
            return GetServiceRssUrl(NopContext.Current.WorkingLanguage.LanguageId);
        }
        ...
        /// </summary>
        /// <param name="languageId">Language identifier</param>
        /// <returns>Service Rss URL</returns>
        /// //Todo: ServiceRSS.aspx
        public static string GetServiceRssUrl(int languageId)
        {
            string url = CommonHelper.GetStoreLocation() + "ServiceRSS.aspx?LanguageId=" + languageId.ToString();
            return url.ToLowerInvariant();
        }
        ...
        /// <summary>
        /// Render Link tag for pager SEO
        /// </summary>
        /// <param name="page"></param>
        /// <param name="relContent"></param>
        /// <param name="url"></param>
        public static void RenderLinkTagPager(Page page, string relContent, string url)
        {
            if (page == null || page.Header == null)
                return;
            ...
            linkTag.Text = string.Format("<link rel=\"{0}\" href=\"{1}\" />", relContent, url);
